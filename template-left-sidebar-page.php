...
<?php
	...
	<div class="column two-thirds reverse">
	<?php } else {?>
	<div class="column three-quarters no-float">
	<?php } ?>
		<?php if (have_posts() ) : while ( have_posts() ) : the_post(); ?>
					<?php if ( has_post_thumbnail() ) { ?><figure><?php the_post_thumbnail( 'two-thirds-page' ); ?><figcaption><?php the_post_thumbnail_caption(); ?></figcaption></figure><?php } ?>
