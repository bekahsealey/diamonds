<?php
/*
 * Template Name: Full Width Photo Feature - No Sidebars
 */
 get_header(); ?>
	<div class="column full">
		<?php if (have_posts() ) : while ( have_posts() ) : the_post(); ?>
					<?php if ( has_post_thumbnail() ) { ?><figure><?php the_post_thumbnail( 'full-featured' ); ?><figcaption><?php the_post_thumbnail_caption(); ?></figcaption></figure><?php } ?>
